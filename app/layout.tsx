...
export const metadata: Metadata = {
  title: "Storix Auth",
  description: "Authentication and Verification for Storix App",
};
...
export default function RootLayout({
  ...
  return (
    ...
    >
      <body className="min-h-screen bg-gray-950 flex flex-col relative text-gray-50 font-sans overflow-x-hidden selection:bg-[#F16A2D]/30">
